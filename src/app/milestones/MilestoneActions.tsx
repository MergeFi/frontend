  ...
  return (
    <div className="mt-4 flex items-center gap-2">
      ...
      <input
        ...
        className="w-24 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-900 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:border-slate-800 dark:bg-slate-900 dark:text-white dark:focus:ring-offset-slate-900"
      />
      <Button
        size="sm"
        variant="outline"
