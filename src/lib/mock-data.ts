...
export const mockReputationProfiles: Record<string, ReputationProfile> = {
  ...
  devrel_ana: {
    ...
    organizations: ["core-indexer", "mergefi"],
    topClients: ["stellar-labs", "core-indexer"],
  },
  qa_marcus: {
    handle: "qa_marcus",
    ...
    mergedPRs: 19,
    completionRate: 0.95,
    avgReviewTimeHours: 16,
    onTimeDeliveryRate: 0.89,
    languages: ["Go", "TypeScript", "Python"],
    organizations: ["stellar-wallet-kit", "mergefi"],
    topClients: ["stellar-wallet-kit", "openzeppelin"],
  },
  linh_dev: {
    handle: "linh_dev",
    ...
    organizations: ["soroban-escrow-sdk", "mergefi"],
    topClients: ["soroban-foundation", "mergefi"],
  },
};
