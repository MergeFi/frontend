...
export const mockBounties: Bounty[] = [
  ...
  },
  {
    ...
    org: "stellar-labs",
    issueNumber: 504,
    title: "Implement Passkey-based hardware signer transport",
    description:
      "Allow WebAuthn passkey signatures alongside Freighter extension. Escrow is fully funded and ready to be claimed.",
    reward: 350,
    asset: "USDC",
    difficulty: "advanced",
    status: "funded",
    deadline: new Date(Date.now() + 14 * 86400000).toISOString(),
    labels: ["security", "webauthn", "feature"],
    escrowId: "escrow-stellar-504",
  },
  {
    id: "b7",
    repo: "soroban-escrow-sdk",
    org: "mergefi",
    issueNumber: 32,
    title: "Support multi-sig release authorization in smart contract bindings",
    description:
      "PR has been merged and escrow release transaction is confirmed on-chain. Awaiting final payout settlement.",
    reward: 500,
    asset: "USDC",
    difficulty: "advanced",
    status: "merged",
    deadline: new Date(Date.now() - 1 * 86400000).toISOString(),
    labels: ["smart-contracts", "soroban"],
    claimedBy: "priyaeth",
    escrowId: "escrow-soroban-32",
  },
  {
    id: "b8",
    repo: "docs-site",
    org: "mergefi",
    issueNumber: 15,
    title: "Translate escrow quickstart guide to Spanish and Japanese",
    description:
      "Bounty was refunded to the sponsor after scope was consolidated into the core documentation overhaul.",
    reward: 80,
    asset: "USDC",
    difficulty: "beginner",
    status: "refunded",
  ...
  },
  {
    ...
    org: "stellar-labs",
    issueNumber: 210,
    title: "Add GraphQL subscription support for real-time ledger events",
    description:
      "Bounty expired without an accepted claim before the project deadline. Ready for sponsor reassessment.",
    reward: 200,
    asset: "XLM",
    difficulty: "intermediate",
    status: "expired",
    deadline: new Date(Date.now() - 12 * 86400000).toISOString(),
    labels: ["graphql", "realtime"],
  },
];
